...
We aim to win at least one first prize in the EU Datathon 2021.
...
- For Challenge 1, we submit [Green Deal Data Observatory](http://greendeal.dataobservatory.eu/). - For Challenge 2, we submit our [Economy Data Observatory](https://economy.dataobservatory.eu/), which will initially focus on small- and medium sized enterprises, competition, competitiveness, and innovation.
- For Challenge 3, we submit our [Digital Music Observatory](https://music.dataobservatory.eu/) to highlight our efforts in trustworthy, ethical AI, and to find a new balance between the interests of artists and music audiences. 
