...
url_custom = [{icon_pack = "fab", icon="play-circle", name="Competition Data Observatory", url = "competition-data-observatory.netlify.app/"}]
...
Our [Competition Data Observatory](https://competition-data-observatory.netlify.app/) is a fully automated, open source, open data observatory that produces new indicators from open data sources and experimental big data sources, with authoritative copies and a modern API.
