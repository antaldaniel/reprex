...
<td style="text-align: center;">{{< figure src="/png/fuds/wikibase/fu_better_view.png" caption="For a better readability, you can acces this document in HTML, PDF, and EPUB [here](https://reprex.nl/documents/fu/fu.html)." numbered="false" >}}</td>
...
<td style="text-align: center;">{{< figure src="/png/fuds/slides/D_Antal_20250306_Tartu/D_Antal_20250306_Tartu_06.png" caption="The Finno-Ugric Data Sharing Space builds on a prior project that unified all known music ever recorded or produced in Slovakia. Although Slovak music represents a relatively compact cultural domain, the relevant information was scattered across multiple public and private institutions, each with its own metadata structures, languages, and access constraints." numbered="false" >}}</td>
...
<td style="text-align: center;">{{< figure src="/png/fuds/slides/D_Antal_20250306_Tartu/D_Antal_20250306_Tartu_02.png" caption="Our project idea started to develop on the Wikimedia CEE 2024 Meeting when we discussed with Finnish, Estonian and Hungarian Wikipedians the possibility to give a boost to participation of minorities from the Finno-Ugric language group in Wikimedia projects." numbered="false" >}}</td>
...
<td style="text-align: center;">{{< figure src="/jpg/dreams/dreams-reprex-poster-2025.jpg" caption="Our unfunded project was presented as a conference paper and as a poster in the Digital Dreams And Practices conference (Digital Humanities in the Nordic &amp; Baltic Countries 2025) conference; it will be avialable as a peer reviewed publication later this year. You can download the poster in [pdf](/documents/poster/dreams-reprex-poster-2025.pdf)" numbered="false" >}}</td>
...
<td style="text-align: center;">{{< figure src="/png/fuds/slides/D_Antal_20250306_Tartu/D_Antal_20250306_Tartu_09.png" caption="" numbered="false" >}}</td>
...
From the [Livonian Place Name Catalogue](https://www.livonian.lv/en/publications/the-livonian-place-name-catalogue/), the place *Irē (Livonian)* / *Mazirbe (Latvian)* is one of the most significant locations in Livonian cultural memory. The system should be able to:
...
<td style="text-align: center;">{{< figure src="/png/fuds/slides/D_Antal_20250306_Tartu/D_Antal_20250306_Tartu_11.png" caption="" numbered="false" >}}</td>
...
<td style="text-align: center;">{{< figure src="/png/fuds/slides/D_Antal_20250306_Tartu/D_Antal_20250306_Tartu_14.png" caption="" numbered="false" >}}</td>
...
<td style="text-align: center;">{{< figure src="/png/fuds/slides/D_Antal_20250306_Tartu/D_Antal_20250306_Tartu_16.png" caption="" numbered="false" >}}</td>
...
<td style="text-align: center;">{{< figure src="/png/fuds/slides/D_Antal_20250306_Tartu/D_Antal_20250306_Tartu_20.png" caption="" numbered="false" >}}</td>
