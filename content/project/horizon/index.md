...
Our Digital Music Observatory grew out of a 12-country music data cooperation and has hundreds of indicators---most of them never used by scientific researchers.  We are looking for scientific partners in various applied music research to use, and further develop our data within the framework of the Horizon Europe call, and the Music Moves Europe policy framework.

We are particularly interested to work with researchers on the following topics:
- Measuring local content in streaming and broadcasting with the measurable definitions of local or national music (similar to radio quotas in Europe.)
...
- Researchers with a quantitative music sociology background for measuring music’s contribution to well-being.
...
We are also welcoming interest from cultural statistics practitioners. 
...
What we provide for our partners is exclusive scientific access to highly valuable quantitative datasets in music, particularly nationally representative audience surveys, nationally representative music creator surveys, and large music streaming data. We provide know-how, data science infrastructure on the best value for money data collection via surveys or big data by utilizing pre-existing open science or open government sources.
