...
In this example, we show a simple indicator: the *Turnover in Radio
Broadcasting Enterprises* in many European countries. This is an
important demand driver in the Music economy pillar of our Digital Music
Observatory, and important indicator in our more general Cultural &
...
Our version of this statistical indicator is documented following the [FAIR
...
national accounts, which imply scrutinizing accounting records that measure economic activity at a national level. Our curated data observatories bring together many available data around important domains. Our *Digital Music
...
around the same key term ([radio
...
Our passion for documentation standards and best practices goes much further: our data uses [Statistical Data and Metadata
