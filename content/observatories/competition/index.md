...
<tbody>
<tr class="odd">
<td style="text-align: center;">{{< figure src="/img/blogposts_2021/global_problem_1_climate_change_5_plots.png" caption="**Novel data products**<br>" numbered="false" >}}</td>
...
<tr class="odd">
<td style="text-align: center;">{{< figure src="//img/blogposts_2021/noaa-WWVD4wXRX38-unsplash-edited.png" caption="**Better data**<br>" numbered="false" >}}</td>
...
<tr class="odd">
<td style="text-align: center;">{{< figure src="//img/blogposts_2021/Gold_panning_at_Bonanza_Creek_4x6.png" caption="**Never seen data**<br>" numbered="false" >}}</td>
...
<tbody>
<tr class="odd">
<td style="text-align: center;">{{< figure src="//img/blogposts_2021/zenodo_global_problem_1_climate_change.png" caption="**Impact**<br>" numbered="false" >}}</td>
...
<tr class="odd">
<td style="text-align: center;">{{< figure src="//img/blogposts_2021/Sisyphus_Bodleian_Library.png" caption="**Easy-to-use data**<br>" numbered="false" >}}</td>
...
<tbody>
<tr class="odd">
<td style="text-align: center;">{{< figure src="//img/blogposts_2021/belgium_problem_maps.png" caption="**Big picture**<br>" numbered="false" >}}</td>
...
<tr class="odd">
<td style="text-align: center;">{{< figure src="//img/blogposts_2021/firing_squad.png" caption="**Better data**<br>" numbered="false" >}}</td>
